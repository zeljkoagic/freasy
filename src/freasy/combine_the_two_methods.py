...
def vote_kl_and_ws(dist_kl, dist_ws):
    voted = []
    for lang, prob_kl in dist_kl:
...
for sentence in target_sentences:
    ...
    predicted_best_single_source_kl, source_distribution_kl = \
        source_weights["klcpos3"][args.granularity][sentence.idx]
