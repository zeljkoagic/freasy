...
for data in [(test_data, X_test, Y_test), (training_data, X_train, Y_train)]:
    ...
    for item in the_data:
        ...
        ranks[target_lang] = 1000  # TODO target_lang is always best!!!
        ...
        y_val[index_of_max] = 1  # TODO Here is the best source (= target_lang!!!)
        # add to training data
        Y.append(y_val.tolist())

X_train = sequence.pad_sequences(X_train, maxlen=16, dtype=float)
X_test = sequence.pad_sequences(X_test, maxlen=16, dtype=float)
